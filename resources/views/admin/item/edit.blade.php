        ...
        <div class="card-body">
            <form action="{{ route('item.update', $items->id) }}" method="post" enctype="multipart/form-data">
                ...
                <div hidden class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" readonly name="merchant_id" class="form-control" id="merchant_id" value="{{$items->merchant_id}}" />
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        ...
                        <img src="{{ asset('uploads/item/'.$items->image) }}" width="70px" height="70px" alt="Image">
                    </div>
                </div>
